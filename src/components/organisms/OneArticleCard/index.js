    ...
    return (
        <>
            <div className="border-2 rounded-md m-2">
                ...
                {/*    Technology*/}
                {/*</span>*/}
                <h3 className="mb-1 mt-2 text-work-sans font-semibold text-2xl ease-out duration-300 hover:animate-pulse hover:text-indigo-500 active:text-indigo-400 visited:text-indigo-900">{title}</h3>
                </div>
