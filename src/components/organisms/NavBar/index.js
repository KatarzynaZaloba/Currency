    ...
    return (
        <>
            <div className="md:flex justify-between items-center py-4 md:py-8 gap-x-1">
                ...
                {/*    <SwitchButton/>*/}
                {/*</div>*/}
                <div className="bg-white text-center md:text-start md:flex md:justify-start justify-center gap-x-10 ease-in duration-300 hover:text-indigo-500 active:text-indigo-400 visited:text-indigo-900">
