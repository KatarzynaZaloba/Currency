        ...
        },
        {
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        href="https://unsplash.com/@vorosbenisop?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Benjamin
                        Voros</a> on <a
                        href="https://unsplash.com/photos/phIFdC6lA4E?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
        ...
        },
        {
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        href="https://unsplash.com/@doctype?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Aleks
                        Dorohovich</a> on <a
                        href="https://unsplash.com/photos/nJdwUHmaY8A?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
        ...
        },
        {
            ...
            body: (
                <>
                    ...
                    <p>Powstaje pytanie, co w przypadku, gdy chcemy przechować jakiś inny typ niż <i>string</i>, coś, co
                        jest
                    ...
                    <p>Następnie, gdy już mam taki <i>string</i> to mogę sobie go przekonwertować z powrotem na tablicę lub
                        obiekt za pomocą
                        metody <b>JSON.parse</b>:</p>
                    <Blockquote>
                    ...
                    <p>Mamy też coś takiego jak <b>sessionStorage</b> i działa to dosyć podobnie do <b>localStorage</b>, ale
                        przechowuje te dane tylko do czasu zamknięcia przeglądarki.</p>
                    <Blockquote>
                        sessionStorage.setItem("klucz", "wartość");<br/><br/>
                        <Comment text="odczyt"/><br/>
                        sessionStorage.getItem("klucz");
                    </Blockquote>
                    <p>Pamiętajmy o tym, że <b>Storage</b> jest tylko dla konkretnej domeny i inne domeny nie mogą
                        odczytywać danych zapisanych przez tę domenę. </p>
                    <p>Photo by <a
                        href="https://unsplash.com/@starvingartistfoodphotography?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Christina
                        Branco</a> on <a
                        href="https://unsplash.com/photos/7P-wc2Z2Ujs?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                    <SmallestHeader>
                        Cookies
                    </SmallestHeader>
                    <p>To najwcześniejsza forma <i>client-side storage</i>. Często są wykorzystywane do przechowywania sesji
                        użytkownika. Przy pierwszym logowaniu jest wysyłany na serwer plik <i>cookie</i> z danymi logowania,
                        dzięki któremu użytkownik nie musi logować się do strony za każdym razem.</p>
                    <p>Kolejną ważną rzeczą, o której trzeba wspomnieć to to, że <i>cookies</i> służą do śledzenia
                        użytkownika.</p>
                    <SmallestHeader>
                        Nagłówek HTTP Set-Cookie
                    </SmallestHeader>
                    <p>W odpowiedzi z serwera możemy dostać nagłówek <b>Set-Cookie</b>, którego wartość jest wysyłana w
                        każdym kolejnym żądaniu. W treści zawarte są klucze i przypisane im wartość oraz moga ale nie muszą
                        być też parametry, np. data wygaśnięcia.</p>
                    <Blockquote>
                        Set-Cookie: klucz=wartosc;
                    </Blockquote>
                    <SmallestHeader>
                        Ustawienie cookies za pomocą JS-a
                    </SmallestHeader>
                    <p>Możemy ustawić <i>cookies</i> za pomocą <i>JavaScript-a</i></p>
                    <Blockquote>
                        document.cookie = "klucz=wartosc";<br/>
                        document.cookie = "klucz2=wartosc2";<br/><br/>
                        <Comment text="odczyt"/><br/>
                    ...
                    <p>Strony mogą zawierać obrazki i inne elementy z innych domen i te domeny mogą również zostawiać
                        ciasteczka. Jeżeli wejdziemy na jakąś stronę, gdzie jest obrazek z <i>Facebooka</i>, to od tego
                        momentu <i>Facebook</i> może śledzić nasze ciasteczka. Są one później wykorzystywane do śledzenia i
                        reklam.</p>
                    <p>Ciasteczka są regulowane prawnie, np. poprzez RODO w krajach Unii Europejskiej.</p>
                </>
            ),
        ...
        },
        {
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        href="https://unsplash.com/@insungyoon?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">insung
                        yoon</a> on <a
                        href="https://unsplash.com/photos/w2JtIQQXoRU?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
        ...
        },
        {
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        href="https://unsplash.com/@laughayette?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Marten
                        Newhall</a> on <a
                        href="https://unsplash.com/photos/uAFjFsMS3YY?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
        ...
        },
        {
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        href="https://unsplash.com/@towfiqu999999?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Towfiqu
                        barbhuiya</a> on <a
                        href="https://unsplash.com/photos/jOeh3Lv88xA?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        ...
                        Lark</a> on <a
                        href="https://unsplash.com/photos/nMffL1zjbw4?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
        ...
        },
        {
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        href="https://unsplash.com/@joeel56?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Nicole
                        Wolf</a> on <a
                        href="https://unsplash.com/photos/CZ9AjMGKIFI?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
        ...
        },
        {
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        href="https://unsplash.com/@homajob?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Scott
                        Graham</a> on <a
                        href="https://unsplash.com/photos/5fNmWej4tAA?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        ...
                        Andreani</a> on <a
                        href="https://unsplash.com/photos/xkBaqlcqeb4?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
        ...
        },
        {
            ...
            body: (
                <>
                    ...
                    <p>Photo by <a
                        href="https://unsplash.com/@afgprogrammer?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Mohammad
                        Rahmani</a> on <a
                        href="https://unsplash.com/photos/oXlXu2qukGE?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
                    </p>
                </>
            ),
